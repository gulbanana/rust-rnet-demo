...
{    
    public static class RustDotnetBindgenDemo
    {
        ...
        [DllImport("rust_dotnet_bindgen_demo", EntryPoint = "rnet_alloc", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr _Alloc( UIntPtr size, UIntPtr align);

        [DllImport("rust_dotnet_bindgen_demo", EntryPoint = "rnet_free", CallingConvention = CallingConvention.Cdecl)]
